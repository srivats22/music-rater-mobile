...
class MobileScreen extends StatefulWidget {
  ...
  MobileScreen({this.musicID, this.musicName, this.artistName, this.genre, this.musicUrl, this.rating = 0.0});
                        ...
                        showModalBottomSheet(
                            ...
                            builder: (context){
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    Text("Posts By: $name", style: TextStyle(fontSize: 18),),
                                    SizedBox(height: 10,),
                                    Expanded(
                                      child: usersPost(uid),
                                    )
